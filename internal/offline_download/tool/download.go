...
func (t *DownloadTask) Transfer() error {
	...
	if toolName == "115 Cloud" || toolName == "115 Open" || toolName == "123 Open" || toolName == "123Pan" || toolName == "Qihoo360" || toolName == "PikPak" || toolName == "Thunder" || toolName == "ThunderX" || toolName == "ThunderBrowser" {
		// 如果不是直接下载到目标路径，则进行转存
