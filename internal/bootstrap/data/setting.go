...
func InitialSettings() []model.SettingItem {
	...
	"epub": {
		...
		//}`, Type: conf.TypeText, Group: model.PREVIEW},
		{Key: "audio_cover", Value: "https://ghproxy.net/raw.githubusercontent.com/alist-org/logo@main/logo.svg", Type: conf.TypeString, Group: model.PREVIEW},
...
(?U)access_token=(.*)&`,
		...
		{Key: conf.OcrApi, Value: "https://ytohrhfdnehf.ap-northeast-1.clawcloudrun.com/ocr/file/json", Type: conf.TypeString, Group: model.GLOBAL},
